...
/**
 * JavaScript library for the fluencybuilder module.
 *
 * @package    mod
...
M.mod_fluencybuilder = M.mod_fluencybuilder || {};

M.mod_fluencybuilder.helper = {
	gY: null,
    ...
    init: function(Y,opts) {
    	...
    	M.mod_fluencybuilder.helper.gY = Y;
...
M.mod_fluencybuilder_session = {
	...
	filter_chosen: function(){
		var filtertext = this.gY.one('#mod_fluencybuilder_session_chosenfilter').get('value');
	...
	filter_unchosen: function(){
		var filtertext = this.gY.one('#mod_fluencybuilder_session_unchosenfilter').get('value');
